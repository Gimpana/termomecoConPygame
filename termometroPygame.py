...
class Termometro():
    def __init__(self):
        self.custome = pygame.image.load("media/termo1.png")
...
class Selector():
    ...
    def __init__(self, unidad="C"):
        self.__customes = []
        self.__customes.append(pygame.image.load("media/posiF.png"))
        self.__customes.append(pygame.image.load("media/posiC.png"))
...
class mianApp():
    ...
    def star(self):
        while True:
            ...
            text = self.entrada.render() #Obtenemos rectangulo blanco y fot de texto y lo asignamos a text
            pygame.draw.rect(self.__screen, (255,255,255), text[0]) #Creacmos rectangulo blanco en con sus datos (posición y tamaño) text[0]
